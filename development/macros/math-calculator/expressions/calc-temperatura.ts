...
const formulaCalculoDaTemperatura = (tipo: MathematicDefines["expressions"]["temperatureVariables"], valor: number): number => {
...
export { formulaCalculoDaTemperatura as Macro_math_calculator_exp_calc_temperatura_method }
