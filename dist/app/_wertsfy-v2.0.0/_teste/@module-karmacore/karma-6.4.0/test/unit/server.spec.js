...
describe('server', () => {
    ...
    describe('constructor', () => {
        it('should log a warning when the first argument is not an instance of Config', async () => {
            ...
            return cfg.parseConfig(null, rawConfig, { promiseConfig: true, throwErrors: true }).then((parsedConfig) => {
                const messageSubstring = 'Passing raw CLI options to `new Server(config, done)` is ' +
                    'deprecated.';
    ...
    describe('reconnecting browser', () => {
        ...
        it('should re-configure disconnected browser which has been restarted', () => {
            ...
            const browser = new Browser(testBrowserId, 'Chrome 19.0', browserCollection, server, mockBrowserSocket, undefined, 0, 0, true, {});
