...
The API-type tool, Wertsfy, came with the objective of facilitating several tasks when developing projects with different sizes and possible scalar models, having a good performance for various infrastructure configurations. And it has the support and acceptance of open source contributions.
...
>> **WMath.PI** 
>>> Type is ``[number]``<br> 
>>> Description: Archimedes or Ludoph number.
>>
>> **WMath.E**
>>> Type is``[number]``<br>
...
>> **WMath.NEWTON**
>>> Type is: ``[number]``<br>
>>> Description: Newton number.
>>
>> **WMath.TESLA**
>>> Type is: ``[number]``<br>
>>> Description: Tesla number.
>>
>> **WMath.SQRT1**
>>> Type is: ``[number]``<br>
>>> Description: Square root of one number. 
>>
>> **WMath.SQRT2**
>>> Type is: ``[number]``<br>
>>> Description: Square root of two number.
>>
>> **WMath.SQRT3**
>>> Type is: ``[number]``<br>
>>> Description: Square root of three number.
>>
>> **WMath.SQRT4**
>>> Type is: ``[number]``<br>
>>> Description: Square root of four number.
>>
>> **WMath.SQRT5**
>>> Type is: ``[number]``<br>
>>> Description: Square root of five number.
>>
>> **WMath.SQRT6**
>>> Type is: ``[number]``<br>
>>> Description: Square root of six number.
>>
>> **WMath.SQRT7**
>>> Type is: ``[number]``<br>
>>> Description: Square root of seven number.
>>
>> **WMath.SQRT8**
>>> Type is: ``[number]``<br>
>>> Description: Square root of eight number.
>>
>> **WMath.SQRT9**
>>> Type is: ``[number]``<br>
>>> Description: Square root of nine number.
>>
>> **WMath.SQRT10**
>>> Type is: ``[number]``<br>
>>> Description: Square root of ten number.
>>
>> **WMath.CBRT1**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of one number.
>>
>> **WMath.CBRT2**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of two number.
>>
>> **WMath.CBRT3**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of three number.
>>
>> **WMath.CBRT4**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of four number.
>>
>> **WMath.CBRT5**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of five number.
>>
>> **WMath.CBRT6**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of six number.
>>
>> **WMath.CBRT7**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of seven number.
>>
>> **WMath.CBRT8**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of eight number.
>>
>> **WMath.CBRT9**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of nine number.
>>
>> **WMath.CBRT10**
>>> Type is: ``[number]``<br>
>>> Description: Cube root of ten number.
>>
>> **WMath.LN2**
>>> Type is: ``[number]``<br>
>>> Description: Natural logarithm of two number.
>>
>> **WMath.LN10**
>>> Type is: ``[number]``<br>
>>> Description: Natural logarithm of ten number.
>>
>> **WMath.LOG2E**
>>> Type is: ``[number]``<br>
>>> Description: Logarithm of two number.
>>
>> **WMath.LOG10E**
>>> Type is: ``[number]``<br>
>>> Description: Logarithm of ten number.
>>
>> **WMath.MAX_VALUE**
>>> Type is: ``[number]``<br>
