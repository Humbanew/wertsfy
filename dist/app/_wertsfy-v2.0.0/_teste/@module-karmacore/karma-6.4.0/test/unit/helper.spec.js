    ...
    describe('browserFullNameToShort', () => {
        ...
        it('should degrade gracefully when OS not recognized', () => {
            expecting('Mozilla/5.0 (X11; U; FreeBSD; i386; en-US; rv:1.7) Gecko/20081216 ' +
                'Firefox/2.0.0.19').to.be.equal('Firefox 2.0.0.19 (FreeBSD 0.0.0)');
        });
        ...
        it('should parse Headless Chrome', () => {
            expecting('Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) ' +
        ...
        it('should parse MS Edge Chromium', () => {
            expecting('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) ' +
