...
export namespace WComponents {
  ...
  export let Calculator = {
    ...
    , calc_Determinante: Component_math_calculator_exp_calc_determinante_method
    , calc_Polinomios: Component_math_calculator_exp_calc_polinomios_method
    , calc_Matrizes: Component_math_calculator_exp_calc_matrizes_method
    , calc_Velocidade: Component_math_calculator_exp_calc_velocidade_method
    , calc_Espaco: Component_math_calculator_exp_calc_espaco_method
    , calc_Tempo: Component_math_calculator_exp_calc_tempo_method
    , calc_Aceleracao: Component_math_calculator_exp_calc_aceleracao_method
    , eq_HorariaTempo: Component_math_calculator_exp_eq_horaria_tempo_method
    , eq_HorariaEspaco: Component_math_calculator_exp_eq_horaria_espaco_method
    , eq_HorariaVelocidade: Component_math_calculator_exp_eq_horaria_velocidade_method
    , eq_HorariaAceleracao: Component_math_calculator_exp_eq_horaria_aceleracao_method
    , eq_HorariaForca: Component_math_calculator_exp_eq_horaria_forca_method
    , eq_HorariaEspacoTempo: Component_math_calculator_exp_eq_horaria_espaco_tempo_method
    , calc_EnergiaCinetica: Component_math_calculator_exp_calc_energia_cinetica_method
    , calc_EnergiaPotencialElastica: Component_math_calculator_exp_calc_energia_potencial_elastica_method
    , calc_EnergiaPotencialGravitacional: Component_math_calculator_exp_calc_energia_potencial_gravitacional_method
    , calc_PotencialMecanico: Component_math_calculator_exp_calc_potencial_mecanico_method
    , calc_PotencialElastico: Component_math_calculator_exp_calc_potencial_elastico_method
    , calc_PlanoInclinadoSemAtrito: Component_math_calculator_exp_calc_plano_inclinado_sem_atrito_method
    , calc_PlanoInclinadoComAtrito: Component_math_calculator_exp_calc_plano_inclinado_com_atrito_method
    , calc_AceleracaoPlanoInclinadoEixoX: Component_math_calculator_exp_calc_aceleracao_no_plano_inclinado_eixo_x_method
    , calc_AceleracaoPlanoInclinadoEixoY: Component_math_calculator_exp_calc_aceleracao_no_plano_inclinado_eixo_y_method
    , calc_LancamentoHorizontal: Component_math_calculator_exp_calc_lancamento_horizontal_method
    , eq_Torricelli: Component_math_calculator_exp_eq_torricelli_method
    , calc_AlturaMaxLancamentoVertical: Component_math_calculator_exp_calc_altura_maxima_lancamento_vertical_method
    , calc_AlcanceLancamentoVertical: Component_math_calculator_exp_calc_alcance_lancamento_vertical_method
    , calc_AlcanceMaxLancamentoVertical: Component_math_calculator_exp_calc_alcance_maximo_lancamento_vertical_method
    , calc_CalorSensivel: Component_math_calculator_exp_calc_calor_sensivel_method
    , calc_CalorLatente: Component_math_calculator_exp_calc_calor_latente_method
    ...
    , calc_VelocidadeLinearMovimentoCircularUniforme: Component_math_calculator_exp_calc_velocidade_linear_movimento_circular_uniforme_method
    , eq_HorariaTempoMovimentoCircularUniformenteVariado: Component_math_calculator_exp_eq_horaria_tempo_movimento_circular_uniformemente_variado_method
    , eq_HorariaEspacoMovimentoCircularUniformenteVariado: Component_math_calculator_exp_eq_horaria_espaco_movimento_circular_uniformente_variado_method
    , calc_TorricelliMovimentoCircularUniformenteVariado: Component_math_calculator_exp_calc_torricelli_movimento_circular_uniformente_variado_method
    , calc_VelocidadeAngularMovimentoCircularUniformenteVariado: Component_math_calculator_exp_calc_aceleracao_angular_movimento_circular_uniformente_variado_method
    , eq_HorariaPosicaoMovimentoHarmonicoSimples: Component_math_calculator_exp_eq_horaria_posicao_movimento_harmonico_simples_method
    , eq_HorariaVelocidadeMovimentoHarmonicoSimples: Component_math_calculator_exp_eq_horaria_velocidade_movimento_harmonico_simples_method
    , eq_HorariaAceleracaoMovimentoHarmonicoSimples: Component_math_calculator_exp_eq_horaria_aceleracao_movimento_harmonico_simples_method
    , calc_Frequencia: Component_math_calculator_exp_calc_frequencia_method
    , calc_Periodo: Component_math_calculator_exp_calc_periodo_method
    , calc_Temperatura: Component_math_calculator_exp_calc_temperatura_method
    , calc_DilatacaoLinear: Component_math_calculator_exp_calc_dilatacao_linear_method
    , calc_DilatacaoSuperficial: Component_math_calculator_exp_calc_dilatacao_superficial_method
    , calc_DilatacaoVolumetrica: Component_math_calculator_exp_calc_dilatacao_volumetrica_method
    , calc_PrincipioFundamentalHidroestaticaHidrodinamica: Component_math_calculator_exp_calc_principio_fundamental_hidroestatica_hidrodinamica_method
    , calc_EmpuxoHidroestaticaHidrodinamica: Component_math_calculator_exp_calc_empuxo_hidroestatica_hidrodinamica_method
    , calc_PesoAparenteHidroestaticaHidrodinamica: Component_math_calculator_exp_calc_aparente_hidroestatica_hidrodinamica_method
    , eq_Lagrange: Component_math_calculator_exp_eq_lagrange_method
    , calc_Atrito: Component_math_calculator_exp_calc_atrito_method
    , calc_LeiDeCoulomb: Component_math_calculator_exp_calc_lei_de_coulomb_method
    , calc_LeiDeOhm: Component_math_calculator_exp_calc_lei_de_ohm_method
    , calc_EfeitoJoule: Component_math_calculator_exp_calc_efeito_joule_method
    , calc_LeiDeLenz: Component_math_calculator_exp_calc_lei_de_lenz_method
    , calc_ForcaEletromotriz: Component_math_calculator_exp_calc_forca_eletromotriz_method
    , calc_ContraForcaEletromotriz: Component_math_calculator_exp_calc_contra_forca_eletromotriz_method
    , calc_EfeitoFotoeletrico: Component_math_calculator_exp_calc_efeito_fotoeletrico_method
    , calc_Densidade: Component_math_calculator_exp_calc_densidade_method
    , calc_Titulacao: Component_math_calculator_exp_calc_titulacao_method
    , calc_Concentracao: Component_math_calculator_exp_calc_concentracao_method
    , calc_Rendimento: Component_math_calculator_exp_calc_rendimento_method
    , calc_LeiDosGases: Component_math_calculator_lei_geral_dos_gases_method
    , calc_RegraDeTresSimples: Component_math_calculator_exp_calc_regra_de_tres_simples_method
    , calc_RegraDeTresComposta: Component_math_calculator_exp_calc_regra_de_tres_composta_method
    , calc_SistemaDeEquacoes: Component_math_calculator_exp_calc_sistema_de_equacoes_method
    , calc_SistemaDeInequacoes: Component_math_calculator_exp_calc_sistema_de_inequacoes_method
    , calc_SistemasLineares: Component_math_calculator_exp_calc_sistemas_lineares_method
    , calc_NumerosComplexos: Component_math_calculator_exp_calc_numeros_complexos_method
    , calc_JurosSimples: Component_math_calculator_juros_simples_method
    , calc_JurosCompostos: Component_math_calculator_juros_compostos_method
    , calc_DistanciaVetorEntreDoisPontosR2: Component_math_calculator_exp_calc_vetor_distancia_entre_dois_pontos_r2_method
    , calc_DistanciaVetorEntreDoisPontosR3: Component_math_calculator_exp_calc_vetor_distancia_entre_dois_pontos_r3_method
    , calc_ModuloVetorR2: Component_math_calculator_exp_calc_modulo_vetor_r2_method
    , calc_ModuloVetorR3: Component_math_calculator_exp_calc_modulo_vetor_r3_method
    , calc_VersorVetorR2: Component_math_calculator_exp_calc_versor_vetor_r2_method
    , calc_VersorVetorR3: Component_math_calculator_exp_calc_versor_vetor_r3_method
    , calc_ProjecaoVetorSobreOutroVetorR2: Component_math_calculator_exp_calc_vetor_sobre_outro_vetor_r2_method
    , calc_ProjecaoVetorSobreOutroVetorR3: Component_math_calculator_exp_calc_vetor_sobre_outro_vetor_r3_method
    , calc_SomaVetoresR2: Component_math_calculator_exp_calc_soma_vetores_r2_method
    , calc_SomaVetoresR3: Component_math_calculator_exp_calc_soma_vetores_r3_method
    , calc_SubtracaoVetoresR2: Component_math_calculator_exp_calc_subtracao_vetores_r2_method
    , calc_SubtracaoVetoresR3: Component_math_calculator_exp_calc_subtracao_vetores_r3_method
    , calc_ProdutoEscalarVetoresR2: Component_math_calculator_exp_calc_produto_escalar_vetores_r2_method
    , calc_ProdutoEscalarVetoresR3: Component_math_calculator_exp_calc_produto_escalar_vetores_r3_method
    , calc_DivisaoVetoresR2: Component_math_calculator_exp_calc_divisao_vetores_r2_method
    , calc_DivisaoVetoresR3: Component_math_calculator_exp_calc_divisao_vetores_r3_method
    , calc_PontoMedioVetorR2: Component_math_calculator_exp_calc_ponto_medio_vetor_r2_method
    , calc_PontoMedioVetorR3: Component_math_calculator_exp_calc_ponto_medio_vetor_r3_method
    , calc_CossenosDiretoresVetorR2: Component_math_calculator_exp_calc_cossenos_diretores_vetor_r2_method
    , calc_CossenosDiretoresVetorR3: Component_math_calculator_exp_calc_cossenos_diretores_vetor_r3_method
    , calc_SinalizacaoQuadrantes: Component_math_calculator_exp_calc_sinalizacao_quadrantes_method
    , calc_SinalizacaoOctantes: Component_math_calculator_exp_calc_sinalizacao_octantes_method
    , calc_QuadradoDePunnet: Component_math_calculator_exp_calc_quadrado_de_punnet_method
    , calc_QuadradoDePunnetExtendido: Component_math_calculator_exp_calc_quadrado_de_punnet_extendido_method
