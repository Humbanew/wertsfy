...
(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) {
    ...
    o(t[i]); return o; } return r; })()({ 1: [function (require, module, exports) {
                ...
                this.complete = function (result) {
                    ...
                    if (returnUrl) {
                        ...
                        if (!isReturnUrlAllowed) {
                            throw new Error('Security: Navigation to '.concat(returnUrl, ' was blocked to prevent malicious exploits.'));
                        }
            ...
            window.karma = new Karma(updater, socket, util.elm('context'), window.open, window.navigator, window.location, window.document);
