...
export namespace WComponents {
  ...
  export let Calculator = {
    ...
    , exp_eqc_horaria_tempo_method: Component_math_calculator_exp_eq_horaria_tempo_method
    , exp_eqc_horaria_espaco_method: Component_math_calculator_exp_eq_horaria_espaco_method
    , exp_eqc_horaria_velocidade_method: Component_math_calculator_exp_eq_horaria_velocidade_method
    , exp_eqc_horaria_aceleracao_method: Component_math_calculator_exp_eq_horaria_aceleracao_method
    , exp_eqc_horaria_forca_method: Component_math_calculator_exp_eq_horaria_forca_method
    , exp_eqc_horaria_espaco_tempo_method: Component_math_calculator_exp_eq_horaria_espaco_tempo_method
    , exp_eqc_horaria_tempo_movimento_circular_uniformente_variado_method: Component_math_calculator_exp_eq_horaria_tempo_movimento_circular_uniformemente_variado_method
    , exp_eqc_horaria_espaco_movimento_circular_uniformente_variado_method: Component_math_calculator_exp_eq_horaria_espaco_movimento_circular_uniformente_variado_method
    , exp_eqc_horaria_posicao_movimento_harmonico_simples_method: Component_math_calculator_exp_eq_horaria_posicao_movimento_harmonico_simples_method
    , exp_eqc_horaria_velocidade_movimento_harmonico_simples_method: Component_math_calculator_exp_eq_horaria_velocidade_movimento_harmonico_simples_method
    , exp_eqc_horaria_aceleracao_movimento_harmonico_simples_method: Component_math_calculator_exp_eq_horaria_aceleracao_movimento_harmonico_simples_method
    , exp_eqc_torricelli_method: Component_math_calculator_exp_eq_torricelli_method
    , exp_eqc_lagrange_method: Component_math_calculator_exp_eq_lagrange_method 
    , exp_clc_fatorial_method: Component_math_calculator_exp_calc_fatorial_method
    , exp_clc_combinacao_method: Component_math_calculator_exp_calc_combinacao_method
    , exp_clc_arranjo_method: Component_math_calculator_exp_calc_arranjo_method
    , exp_clc_probabilidade_method: Component_math_calculator_exp_calc_probabilidade_method
    , exp_clc_conjugado_numero_complexo_method: Component_math_calculator_exp_calc_conjugado_numero_complexo_method
    , exp_clc_relacao_euler_method: Component_math_calculator_exp_calc_relacao_euler_method
    , exp_clc_potencias_de_i_method: Component_math_calculator_exp_calc_potencias_de_i_method
    , exp_clc_porcentagem_method: Component_math_calculator_exp_calc_porcentagem_method
    , exp_clc_determinante_method: Component_math_calculator_exp_calc_determinante_method
    , exp_clc_polinomios_method: Component_math_calculator_exp_calc_polinomios_method
    , exp_clc_matrizes_method: Component_math_calculator_exp_calc_matrizes_method
    , exp_clc_velocidade_method: Component_math_calculator_exp_calc_velocidade_method
    , exp_clc_espaco_method: Component_math_calculator_exp_calc_espaco_method
    , exp_clc_tempo_method: Component_math_calculator_exp_calc_tempo_method
    , exp_clc_aceleracao_method: Component_math_calculator_exp_calc_aceleracao_method
    , exp_clc_energia_cinetica_method: Component_math_calculator_exp_calc_energia_cinetica_method
    , exp_clc_energia_potencial_elastica_method: Component_math_calculator_exp_calc_energia_potencial_elastica_method
    , exp_clc_energia_potencial_gravitacional_method: Component_math_calculator_exp_calc_energia_potencial_gravitacional_method
    , exp_clc_potencial_mecanico_method: Component_math_calculator_exp_calc_potencial_mecanico_method
    , exp_clc_potencial_elastico_method: Component_math_calculator_exp_calc_potencial_elastico_method
    , exp_clc_plano_inclinado_sem_atrito_method: Component_math_calculator_exp_calc_plano_inclinado_sem_atrito_method
    , exp_clc_plano_inclinado_com_atrito_method: Component_math_calculator_exp_calc_plano_inclinado_com_atrito_method
    , exp_clc_aceleracao_plano_inclinado_eixo_x_method: Component_math_calculator_exp_calc_aceleracao_no_plano_inclinado_eixo_x_method
    , exp_clc_aceleracao_plano_inclinado_eixo_y_method: Component_math_calculator_exp_calc_aceleracao_no_plano_inclinado_eixo_y_method
    , exp_clc_lancamento_horizontal_method: Component_math_calculator_exp_calc_lancamento_horizontal_method
    , exp_clc_altura_max_lancamento_vertical_method: Component_math_calculator_exp_calc_altura_maxima_lancamento_vertical_method
    , exp_clc_alcance_lancamento_vertical_method: Component_math_calculator_exp_calc_alcance_lancamento_vertical_method
    , exp_clc_alcance_max_lancamento_vertical_method: Component_math_calculator_exp_calc_alcance_maximo_lancamento_vertical_method
    , exp_clc_calor_sensivel_method: Component_math_calculator_exp_calc_calor_sensivel_method
    , exp_clc_calor_latente_method: Component_math_calculator_exp_calc_calor_latente_method
    , exp_clc_leis_de_newton_method: Component_math_calculator_exp_calc_leis_de_newton_method
    , exp_clc_trabalho_method: Component_math_calculator_exp_calc_trabalho_method
    , exp_clc_consumo_de_energia_method: Component_math_calculator_exp_calc_consumo_de_energia_method
    , exp_clc_forca_gravitacional_method: Component_math_calculator_exp_calc_forca_gravitacional_method
    , exp_clc_aceleracao_centripeta_movimento_circular_uniforme_method: Component_math_calculator_exp_calc_aceleracao_centripeta_movimento_circular_uniforme_method
    ...
    , exp_clc_dilatacao_linear_method: Component_math_calculator_exp_calc_dilatacao_linear_method
    , exp_clc_dilatacao_superficial_method: Component_math_calculator_exp_calc_dilatacao_superficial_method
    , exp_clc_dilatacao_volumetrica_method: Component_math_calculator_exp_calc_dilatacao_volumetrica_method
    , exp_clc_principio_fundamental_hidroestatica_hidrodinamica_method: Component_math_calculator_exp_calc_principio_fundamental_hidroestatica_hidrodinamica_method
    , exp_clc_empuxo_hidroestatica_hidrodinamica_method: Component_math_calculator_exp_calc_empuxo_hidroestatica_hidrodinamica_method
    , exp_clc_peso_aparente_hidroestatica_hidrodinamica_method: Component_math_calculator_exp_calc_aparente_hidroestatica_hidrodinamica_method
    , exp_clc_atrito_method: Component_math_calculator_exp_calc_atrito_method
    , exp_clc_lei_de_coulomb_method: Component_math_calculator_exp_calc_lei_de_coulomb_method
    , exp_clc_lei_de_ohm_method: Component_math_calculator_exp_calc_lei_de_ohm_method
    , exp_clc_efeito_joule_method: Component_math_calculator_exp_calc_efeito_joule_method
    , exp_clc_lei_de_lenz_method: Component_math_calculator_exp_calc_lei_de_lenz_method
    , exp_clc_forca_eletromotriz_method: Component_math_calculator_exp_calc_forca_eletromotriz_method
    , exp_clc_contra_forca_eletromotriz_method: Component_math_calculator_exp_calc_contra_forca_eletromotriz_method
    , exp_clc_efeito_fotoeletrico_method: Component_math_calculator_exp_calc_efeito_fotoeletrico_method
    , exp_clc_densidade_method: Component_math_calculator_exp_calc_densidade_method
    , exp_clc_titulacao_method: Component_math_calculator_exp_calc_titulacao_method
    , exp_clc_concentracao_method: Component_math_calculator_exp_calc_concentracao_method
    , exp_clc_rendimento_method: Component_math_calculator_exp_calc_rendimento_method
    , exp_clc_lei_dos_gases_method: Component_math_calculator_lei_geral_dos_gases_method
    , exp_clc_regra_de_tres_simples_method: Component_math_calculator_exp_calc_regra_de_tres_simples_method
    , exp_clc_regra_de_tres_composta_method: Component_math_calculator_exp_calc_regra_de_tres_composta_method
    , exp_clc_sistema_de_equacoes_method: Component_math_calculator_exp_calc_sistema_de_equacoes_method
    , exp_clc_sistema_de_inequacoes_method: Component_math_calculator_exp_calc_sistema_de_inequacoes_method
    , exp_clc_sistemas_lineares_method: Component_math_calculator_exp_calc_sistemas_lineares_method
