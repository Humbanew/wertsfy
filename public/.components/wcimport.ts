...
export namespace WComponents {
  ...
  export let Calculator = {
    ...
    , exp_eq_horaria_espaco_mcuv_method: Component_math_calculator_exp_eq_horaria_espaco_movimento_circular_uniformente_variado_method
    , exp_eq_horaria_espaco_method: Component_math_calculator_exp_eq_horaria_espaco_method
    , exp_eq_horaria_forca_method: Component_math_calculator_exp_eq_horaria_forca_method
    , exp_eq_horaria_posicao_mhs_method: Component_math_calculator_exp_eq_horaria_posicao_movimento_harmonico_simples_method
    , exp_eq_horaria_tempo_mcuv_method: Component_math_calculator_exp_eq_horaria_tempo_movimento_circular_uniformemente_variado_method
    , exp_eq_horaria_tempo_method: Component_math_calculator_exp_eq_horaria_tempo_method
    , exp_eq_horaria_tempoespaco_method: Component_math_calculator_exp_eq_horaria_espaco_tempo_method
    , exp_eq_horaria_velocidade_mhs_method: Component_math_calculator_exp_eq_horaria_velocidade_movimento_harmonico_simples_method
    , exp_eq_horaria_velocidade_method: Component_math_calculator_exp_eq_horaria_velocidade_method
    , exp_eq_lagrange_method: Component_math_calculator_exp_eq_lagrange_method
    , exp_eq_torricelli_method: Component_math_calculator_exp_eq_torricelli_method
