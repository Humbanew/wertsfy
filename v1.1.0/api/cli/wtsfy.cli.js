...
var hub_aritmeticos_1 = require("../libraries/aritmeticos/hub_aritmeticos");
var hub_conversores_1 = require("../libraries/conversores/hub_conversores");
var Wtsfy;
(function (Wtsfy) {
    var Cli;
    (function (Cli) {
        ...
        console.log(new hub_aritmeticos_1.Aritmeticos());
        console.log(new hub_conversores_1.Conversores());
    })(Cli || (Cli = {}));
})(Wtsfy || (Wtsfy = {}));
