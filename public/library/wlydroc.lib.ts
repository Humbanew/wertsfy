class wLydroc {
   ...
   * @augments idElemento id do elemento a ser adicionado. **[ Type: ``string`` ]**.
   * @description gera um attributo customizado. 
   */
  public coletaAtributoDoElemento(atributo: string, idElemento: string): string {
    const elemento = document.getElementById(idElemento);
