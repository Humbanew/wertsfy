...
import { Component_math_calculator_exp_teo_boltzmann_method } from "./calc/expression.teo-boltzmann.method";
import { Component_math_calculator_exp_teo_coulomb_method } from "./calc/expression.teo-coulomb.method";
import { Component_math_calculator_exp_teo_girard_method } from "./calc/expression.teo-girard.method";
import { Component_math_calculator_exp_teo_pascal_method } from "./calc/expression.teo-pascal.method";
import { Component_math_calculator_exp_teo_pitagoras_method } from "./calc/expression.teo-pitagoras.method";
import { Component_math_calculator_exp_teo_plank_method } from "./calc/expression.teo-plank.method";
import { Component_math_calculator_exp_teo_stevin_method } from "./calc/expression.teo-stevin.method";
import { Component_math_calculator_exp_teo_stirling_method } from "./calc/expression.teo-stirling.method";
import { Component_math_calculator_exp_teo_tales_mileto_method } from "./calc/expression.teo-tales-mileto.method";
import { Component_math_calculator_exp_eq_horaria_aceleracao_method } from "./calc/expression.eq-horaria-aceleracao";
import { Component_math_calculator_exp_eq_horaria_aceleracao_movimento_harmonico_simples_method } from "./calc/expression.eq-horaria-aceleracao-mhs";
import { Component_math_calculator_exp_eq_horaria_espaco_method } from "./calc/expression.eq-horaria-espaco";
import { Component_math_calculator_exp_eq_horaria_espaco_movimento_circular_uniformente_variado_method } from "./calc/expression.eq-horaria-espaco-mcuv";
import { Component_math_calculator_exp_eq_horaria_forca_method } from "./calc/expression.eq-horaria-forca";
import { Component_math_calculator_exp_eq_horaria_posicao_movimento_harmonico_simples_method } from "./calc/expression.eq-horaria-posicao-mhs";
import { Component_math_calculator_exp_eq_horaria_tempo_movimento_circular_uniformemente_variado_method } from "./calc/expression.eq-horaria-tempo-mcuv";
import { Component_math_calculator_exp_eq_horaria_tempo_method } from "./calc/expression.eq-horaria-tempo";
import { Component_math_calculator_exp_eq_horaria_espaco_tempo_method } from "./calc/expression.eq-horaria-tempoespaco";
import { Component_math_calculator_exp_eq_horaria_velocidade_movimento_harmonico_simples_method } from "./calc/expression.eq-horaria-velocidade-mhs";
...
import { Component_math_calculator_exp_calc_alcance_lancamento_vertical_method } from "./calc/expression.calc-alcance-lancamento-vertical";
import { Component_math_calculator_exp_calc_alcance_maximo_lancamento_vertical_method } from "./calc/expression.calc-alcance-maximo-lancamento-vertical";
import { Component_math_calculator_exp_calc_altura_maxima_lancamento_vertical_method } from "./calc/expression.calc-altura-max-lancamento-vertical";
import { Component_math_calculator_exp_calc_arranjo_method } from "./calc/expression.calc-arranjo";
import { Component_math_calculator_exp_calc_atrito_method } from "./calc/expression.calc-atrito";
import { Component_math_calculator_exp_calc_calor_latente_method } from "./calc/expression.calc-calor-latente";
import { Component_math_calculator_exp_calc_calor_sensivel_method } from "./calc/expression.calc-calor-sensivel";
import { Component_math_calculator_exp_calc_combinacao_method } from "./calc/expression.calc-combinacao";
import { Component_math_calculator_exp_calc_concentracao_method } from "./calc/expression.calc-concentracao";
...
import { Component_math_calculator_exp_calc_energia_cinetica_method } from "./calc/expression.calc-energia-cinetica";
import { Component_math_calculator_exp_calc_energia_potencial_elastica_method } from "./calc/expression.calc-energia-potencial-elastica";
import { Component_math_calculator_exp_calc_energia_potencial_gravitacional_method } from "./calc/expression.calc-energia-potencial-gravitacional";
import { Component_math_calculator_exp_calc_espaco_method } from "./calc/expression.calc-espaco";
import { Component_math_calculator_exp_calc_fatorial_method } from "./calc/expression.calc-fatorial";
import { Component_math_calculator_exp_calc_forca_eletromotriz_method } from "./calc/expression.calc-forca-eletromotriz";
import { Component_math_calculator_exp_calc_forca_gravitacional_method } from "./calc/expression.calc-forca-gravitacional";
import { Component_math_calculator_exp_calc_frequencia_method } from "./calc/expression.calc-frequencia";
import { Component_math_calculator_juros_compostos_method } from "./calc/expression.calc-juros-compostos";
import { Component_math_calculator_juros_simples_method } from "./calc/expression.calc-juros-simples";
import { Component_math_calculator_exp_calc_lancamento_horizontal_method } from "./calc/expression.calc-lancamento-horizontal";
import { Component_math_calculator_exp_calc_lei_de_coulomb_method } from "./calc/expression.calc-lei-de-coulomb";
import { Component_math_calculator_exp_calc_lei_de_lenz_method } from "./calc/expression.calc-lei-de-lenz";
import { Component_math_calculator_exp_calc_lei_de_ohm_method } from "./calc/expression.calc-lei-de-ohm";
...
import { Component_math_calculator_exp_calc_regra_de_tres_simples_method } from "./calc/expression.calc-regra-de-tres-simples";
import { Component_math_calculator_exp_calc_relacao_euler_method } from "./calc/expression.calc-relacao-euler";
import { Component_math_calculator_exp_calc_rendimento_method } from "./calc/expression.calc-rendimento";
import { Component_math_calculator_exp_calc_sinalizacao_octantes_method } from "./calc/expression.calc-sinalizacao-octantes";
import { Component_math_calculator_exp_calc_sinalizacao_quadrantes_method } from "./calc/expression.calc-sinalizacao-quadrantes";
...
import { Component_math_calculator_exp_calc_torricelli_movimento_circular_uniformente_variado_method } from "./calc/expression.calc-torricelli-mcuv";
import { Component_math_calculator_exp_calc_trabalho_method } from "./calc/expression.calc-trabalho";
import { Component_math_calculator_exp_calc_velocidade_angular_movimento_circular_uniforme_method } from "./calc/expression.calc-vel-ang-mcu";
...
export namespace WComponents {
  ...
  export let Mathematic = {

    avogadro_constant: Component_math_corebase_avogadro_constant
  ...
  export let Calculator = {
    ...
    , teoGirard: Component_math_calculator_exp_teo_girard_method
    , teoTalesMileto: Component_math_calculator_exp_teo_tales_mileto_method
    , teoPitagoras: Component_math_calculator_exp_teo_pitagoras_method
    , calcFatorial: Component_math_calculator_exp_calc_fatorial_method
    , calcCombinacao: Component_math_calculator_exp_calc_combinacao_method
    , calcArranjo: Component_math_calculator_exp_calc_arranjo_method
    , calcProbabilidade: Component_math_calculator_exp_calc_probabilidade_method
    , calcConjugadoNumComplexo: Component_math_calculator_exp_calc_conjugado_numero_complexo_method
    , teoStirling: Component_math_calculator_exp_teo_stirling_method
    , calcRelacaoEuler: Component_math_calculator_exp_calc_relacao_euler_method
    , calcPotenciasDeI: Component_math_calculator_exp_calc_potencias_de_i_method
    , calcPorcentagem: Component_math_calculator_exp_calc_porcentagem_method
    , calcDeterminante: Component_math_calculator_exp_calc_determinante_method
    , calcPolinomios: Component_math_calculator_exp_calc_polinomios_method
    , calcMatrizes: Component_math_calculator_exp_calc_matrizes_method
    , calcVelocidade: Component_math_calculator_exp_calc_velocidade_method
    , calcEspaco: Component_math_calculator_exp_calc_espaco_method
    , calcTempo: Component_math_calculator_exp_calc_tempo_method
    , calcAceleracao: Component_math_calculator_exp_calc_aceleracao_method
    , eqHorariaTempo: Component_math_calculator_exp_eq_horaria_tempo_method
    , eqHorariaEspaco: Component_math_calculator_exp_eq_horaria_espaco_method
    , eqHorariaVelocidade: Component_math_calculator_exp_eq_horaria_velocidade_method
    , eqHorariaAceleracao: Component_math_calculator_exp_eq_horaria_aceleracao_method
    , eqHorariaForca: Component_math_calculator_exp_eq_horaria_forca_method
    , eqHorariaEspacoTempo: Component_math_calculator_exp_eq_horaria_espaco_tempo_method
    , calcEnergiaCinetica: Component_math_calculator_exp_calc_energia_cinetica_method
    , calcEnergiaPotencialElastica: Component_math_calculator_exp_calc_energia_potencial_elastica_method
    , calcEnergiaPotencialGravitacional: Component_math_calculator_exp_calc_energia_potencial_gravitacional_method
    , calcPotencialMecanico: Component_math_calculator_exp_calc_potencial_mecanico_method
    , calcPotencialElastico: Component_math_calculator_exp_calc_potencial_elastico_method
    , calcPlanoInclinadoSemAtrito: Component_math_calculator_exp_calc_plano_inclinado_sem_atrito_method
    , calcPlanoInclinadoComAtrito: Component_math_calculator_exp_calc_plano_inclinado_com_atrito_method
    , calcAceleracaoPlanoInclinadoEixoX: Component_math_calculator_exp_calc_aceleracao_no_plano_inclinado_eixo_x_method
    , calcAceleracaoPlanoInclinadoEixoY: Component_math_calculator_exp_calc_aceleracao_no_plano_inclinado_eixo_y_method
    , calcLancamentoHorizontal: Component_math_calculator_exp_calc_lancamento_horizontal_method
    , eqTorricelli: Component_math_calculator_exp_eq_torricelli_method
    , calcAlturaMaxLancamentoVertical: Component_math_calculator_exp_calc_altura_maxima_lancamento_vertical_method
    , calcAlcanceLancamentoVertical: Component_math_calculator_exp_calc_alcance_lancamento_vertical_method
    , calcAlcanceMaxLancamentoVertical: Component_math_calculator_exp_calc_alcance_maximo_lancamento_vertical_method
    , calcCalorSensivel: Component_math_calculator_exp_calc_calor_sensivel_method
    , calcCalorLatente: Component_math_calculator_exp_calc_calor_latente_method
    , calcLeisDeNewton: Component_math_calculator_exp_calc_leis_de_newton_method
    , calcTrabalho: Component_math_calculator_exp_calc_trabalho_method
    , calcConsumoDeEnergia: Component_math_calculator_exp_calc_consumo_de_energia_method
    , teoPascal: Component_math_calculator_exp_teo_pascal_method
    , teoStevin: Component_math_calculator_exp_teo_stevin_method
    , teoBoltzmann: Component_math_calculator_exp_teo_boltzmann_method
    , teoCoulomb: Component_math_calculator_exp_teo_coulomb_method
    , teoPlank: Component_math_calculator_exp_teo_plank_method
    , calcForcaGravitacional: Component_math_calculator_exp_calc_forca_gravitacional_method
    , calcAceleracaoCentripetaMovimentoCircularUniforme: Component_math_calculator_exp_calc_aceleracao_centripeta_movimento_circular_uniforme_method
    , calcVelocidadeAngularMovimentoCircularUniforme: Component_math_calculator_exp_calc_velocidade_angular_movimento_circular_uniforme_method
    , calcVelocidadeLinearMovimentoCircularUniforme: Component_math_calculator_exp_calc_velocidade_linear_movimento_circular_uniforme_method
    , eqHorariaTempoMovimentoCircularUniformenteVariado: Component_math_calculator_exp_eq_horaria_tempo_movimento_circular_uniformemente_variado_method
    , eqHorariaEspacoMovimentoCircularUniformenteVariado: Component_math_calculator_exp_eq_horaria_espaco_movimento_circular_uniformente_variado_method
    , calcTorricelliMovimentoCircularUniformenteVariado: Component_math_calculator_exp_calc_torricelli_movimento_circular_uniformente_variado_method
    , calcVelocidadeAngularMovimentoCircularUniformenteVariado: Component_math_calculator_exp_calc_aceleracao_angular_movimento_circular_uniformente_variado_method
    , eqHorariaPosicaoMovimentoHarmonicoSimples: Component_math_calculator_exp_eq_horaria_posicao_movimento_harmonico_simples_method
    , eqHorariaVelocidadeMovimentoHarmonicoSimples: Component_math_calculator_exp_eq_horaria_velocidade_movimento_harmonico_simples_method
    , eqHorariaAceleracaoMovimentoHarmonicoSimples: Component_math_calculator_exp_eq_horaria_aceleracao_movimento_harmonico_simples_method
    , calcFrequencia: Component_math_calculator_exp_calc_frequencia_method
    , calcPeriodo: Component_math_calculator_exp_calc_periodo_method
    , calcTemperatura: Component_math_calculator_exp_calc_temperatura_method
    , calcDilatacaoLinear: Component_math_calculator_exp_calc_dilatacao_linear_method
    , calcDilatacaoSuperficial: Component_math_calculator_exp_calc_dilatacao_superficial_method
    , calcDilatacaoVolumetrica: Component_math_calculator_exp_calc_dilatacao_volumetrica_method
    , calcPrincipioFundamentalHidroestaticaHidrodinamica: Component_math_calculator_exp_calc_principio_fundamental_hidroestatica_hidrodinamica_method
    , calcEmpuxoHidroestaticaHidrodinamica: Component_math_calculator_exp_calc_empuxo_hidroestatica_hidrodinamica_method
    , calcPesoAparenteHidroestaticaHidrodinamica: Component_math_calculator_exp_calc_aparente_hidroestatica_hidrodinamica_method
    , eqLagrange: Component_math_calculator_exp_eq_lagrange_method
    , calcAtrito: Component_math_calculator_exp_calc_atrito_method
    , calcLeiDeCoulomb: Component_math_calculator_exp_calc_lei_de_coulomb_method
    , calcLeiDeOhm: Component_math_calculator_exp_calc_lei_de_ohm_method
    , calcEfeitoJoule: Component_math_calculator_exp_calc_efeito_joule_method
    , calcLeiDeLenz: Component_math_calculator_exp_calc_lei_de_lenz_method
    , calcForcaEletromotriz: Component_math_calculator_exp_calc_forca_eletromotriz_method
    , calcContraForcaEletromotriz: Component_math_calculator_exp_calc_contra_forca_eletromotriz_method
    , calcEfeitoFotoeletrico: Component_math_calculator_exp_calc_efeito_fotoeletrico_method
    , calcDensidade: Component_math_calculator_exp_calc_densidade_method
    , calcTitulacao: Component_math_calculator_exp_calc_titulacao_method
    , calcConcentracao: Component_math_calculator_exp_calc_concentracao_method
    , calcRendimento: Component_math_calculator_exp_calc_rendimento_method
    , calcLeiDosGases: Component_math_calculator_lei_geral_dos_gases_method
    , calcRegraDeTresSimples: Component_math_calculator_exp_calc_regra_de_tres_simples_method
    , calcRegraDeTresComposta: Component_math_calculator_exp_calc_regra_de_tres_composta_method
    , calcSistemaDeEquacoes: Component_math_calculator_exp_calc_sistema_de_equacoes_method
    , calcSistemaDeInequacoes: Component_math_calculator_exp_calc_sistema_de_inequacoes_method
    , calcSistemasLineares: Component_math_calculator_exp_calc_sistemas_lineares_method
    , calcNumerosComplexos: Component_math_calculator_exp_calc_numeros_complexos_method
    , calcJurosSimples: Component_math_calculator_juros_simples_method
    , calcJurosCompostos: Component_math_calculator_juros_compostos_method
    , calcDistanciaVetorEntreDoisPontosR2: Component_math_calculator_exp_calc_vetor_distancia_entre_dois_pontos_r2_method
    , calcDistanciaVetorEntreDoisPontosR3: Component_math_calculator_exp_calc_vetor_distancia_entre_dois_pontos_r3_method
    , calcModuloVetorR2: Component_math_calculator_exp_calc_modulo_vetor_r2_method
    , calcModuloVetorR3: Component_math_calculator_exp_calc_modulo_vetor_r3_method
    , calcVersorVetorR2: Component_math_calculator_exp_calc_versor_vetor_r2_method
    , calcVersorVetorR3: Component_math_calculator_exp_calc_versor_vetor_r3_method
    , calcProjecaoVetorSobreOutroVetorR2: Component_math_calculator_exp_calc_vetor_sobre_outro_vetor_r2_method
    , calcProjecaoVetorSobreOutroVetorR3: Component_math_calculator_exp_calc_vetor_sobre_outro_vetor_r3_method
    , calcSomaVetoresR2: Component_math_calculator_exp_calc_soma_vetores_r2_method
    , calcSomaVetoresR3: Component_math_calculator_exp_calc_soma_vetores_r3_method
    , calcSubtracaoVetoresR2: Component_math_calculator_exp_calc_subtracao_vetores_r2_method
    , calcSubtracaoVetoresR3: Component_math_calculator_exp_calc_subtracao_vetores_r3_method
    , calcProdutoEscalarVetoresR2: Component_math_calculator_exp_calc_produto_escalar_vetores_r2_method
    , calcProdutoEscalarVetoresR3: Component_math_calculator_exp_calc_produto_escalar_vetores_r3_method
    , calcDivisaoVetoresR2: Component_math_calculator_exp_calc_divisao_vetores_r2_method
    , calcDivisaoVetoresR3: Component_math_calculator_exp_calc_divisao_vetores_r3_method
    , calcPontoMedioVetorR2: Component_math_calculator_exp_calc_ponto_medio_vetor_r2_method
    , calcPontoMedioVetorR3: Component_math_calculator_exp_calc_ponto_medio_vetor_r3_method
    , calcCossenosDiretoresVetorR2: Component_math_calculator_exp_calc_cossenos_diretores_vetor_r2_method
    , calcCossenosDiretoresVetorR3: Component_math_calculator_exp_calc_cossenos_diretores_vetor_r3_method
    , calcSinalizacaoQuadrantes: Component_math_calculator_exp_calc_sinalizacao_quadrantes_method
    , calcSinalizacaoOctantes: Component_math_calculator_exp_calc_sinalizacao_octantes_method
    , calcQuadradoDePunnet: Component_math_calculator_exp_calc_quadrado_de_punnet_method
    , calcQuadradoDePunnetExtendido: Component_math_calculator_exp_calc_quadrado_de_punnet_extendido_method
